            ...
            itemView.setOnClickListener {
                ...
                val optionCompat: ActivityOptionsCompat =
                    ActivityOptionsCompat.makeSceneTransitionAnimation(
                        ...
                        Pair(imgPhoto, itemView.context.getString(R.string.profile)),
                        Pair(tvName, itemView.context.getString(R.string.heroes_name)),
                        Pair(tvDescription, itemView.context.getString(R.string.description))
                    )
